       ...
       <div class="canvas">
        <div class="top-cont">
          <div class="cont-tombol-finish">
              ...
              <img src="../assets/png/FinishPage/Last/gep sebelumnya.png" class="sebelum" @mouseover="showgep" @mouseleave="showgep" @click="toggGep=true">              
              <img src="../assets/png/FinishPage/home.png" class="home" @click="home">
              <div class="btn-feedback">
                Feedback
              </div>  
          </div>
          <throwback v-show="toggGep" @close-modal="toggGep=false" :karyalength="karyalength" :arrkarya="arrkarya" />
        </div>
      </div>
    </div>
</template>
